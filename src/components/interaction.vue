...
export default {
  ...
  data () {
    return {
      list:[
		{content:"预约查档",path:"/archDetail_sq",url:"static/img/center2.png"},
		//上海版本
      	//{content:"预约查档",path:"/center",url:"static/img/center.png"},
      	// {content:"查档指南",path:"/guide",url:"static/img/guide.png"},
      	{content:"留言咨询",path:"/backfeed",url:"static/img/backfeed3.png"},
        {content:"满意度调查",path:"/survey",url:"static/img/consult3.png"},
